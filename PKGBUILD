...
pkgver=6.0.1
pkgrel=7
pkgdesc="GlobalProtect VPN client for the University of York"
arch=('x86_64')
...
source=("gpui.service"
      	"globalprotect-ui_$pkgver-6uoy0_amd64.deb")
...
package() {
	...
	install -Dm644 -t "$pkgdir/usr/lib/systemd" "$GPDIR/gpd.service" "$GPDIR/gpa.service"
